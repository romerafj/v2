    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Modulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modulo_agrupacion', to='users.modulo', verbose_name='modulo')),
                ('rol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.rol', verbose_name='rol')),
            ],
            options={
